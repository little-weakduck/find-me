...
!(function (t, e) {
  ...
  const a = "swal2-",
    ...
    ct = (t) => {
      const e = (() => {
        ...
        return (
          !!t &&
          (t.remove(),
          Z([document.documentElement, document.body], [c["no-backdrop"], c["toast-shown"], c["has-column"]]),
          !0)
        );
      })();
    ...
    mt = (t, e) => {
      ...
      n &&
        o &&
        (e.showConfirmButton || e.showDenyButton || e.showCancelButton ? X(n) : G(n),
        U(n, e, "actions"),
        (function (t, e, n) {
          const o = S(),
            i = M(),
          ...
          gt(o, "confirm", n),
            ...
            n.reverseButtons &&
              (n.toast
                ...
                : (t.insertBefore(s, e), t.insertBefore(i, e), t.insertBefore(o, e)));
        })(n, o, e),
        _(o, e.loaderHtml || ""),
        U(o, e, "loader"));
    };
  ...
  const ft = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
    ...
    kt = (t, e) => {
      ["string", "number"].includes(typeof e)
        ? (t.value = "".concat(e))
        : w(e) ||
          p('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(typeof e, '"'));
    },
    Bt = {};
  (Bt.text =
    Bt.email =
    ...
    Bt.tel =
    Bt.url =
      (t, e) => (kt(t, e.inputValue), Ct(t, t, e), vt(t, e), (t.type = e.input), t)),
  ...
  const Et = (t, e) => {
      ...
      n &&
        (U(n, e, "htmlContainer"),
        e.html ? (lt(e.html, n), X(n, "block")) : e.text ? ((n.textContent = e.text), X(n, "block")) : G(n),
        ((t, e) => {
          const n = k();
          if (!n) return;
  ...
  const te = (t) => {
    null === Qt &&
      ...
      ((Qt = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right"))),
  ...
  function ee(t, e, n, o) {
    F() ? le(t, o) : (s(n).then(() => le(t, o)), qt(i)),
      Zt
        ...
        : e.remove(),
      N() &&
        (null !== Qt && ((document.body.style.paddingRight = "".concat(Qt, "px")), (Qt = null)),
        (() => {
  ...
  const se = (t) => {
    ...
    de = (t, e) => {
      ...
      n &&
        ...
        (!e && et(S()) && (e = S()),
        X(n),
        e && (G(e), o.setAttribute("data-button-to-replace", e.className), n.insertBefore(o, e)),
        Y([t, n], c.loading));
    },
    pe = (t) => (t.checked ? 1 : 0),
    ...
    he = (t, e) => {
      ...
      b(e.inputOptions) || w(e.inputOptions)
        ...
        ? o(e.inputOptions)
        : m("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(typeof e.inputOptions));
    },
    fe = (t, e) => {
      const n = t.getInput();
      n &&
  ...
  const be = (t) => {
    ...
    we = (t, e) => {
      const n = r.innerParams.get(t);
      if (!n.input)
        return void m('The "input" parameter is needed to be set when using returnInputValueOn'.concat(d(e)));
      const o = t.getInput(),
        i = ((t, e) => {
          const n = t.getInput();
          if (!n) return null;
        ...
        "object" != typeof t[0] || rn(t[0])
          ? ["title", "html", "icon"].forEach((n, o) => {
              ...
              "string" == typeof i || rn(i)
                ? (e[n] = i)
                : void 0 !== i &&
                  m("Unexpected type of ".concat(n, '! Expected "string" or "Element", got ').concat(typeof i));
            })
          : Object.assign(e, t[0]),
        e
      );
  ...
  function Sn(t) {
    !(function (t) {
      t.inputValidator ||
        ("email" === t.input && (t.inputValidator = Ln.email), "url" === t.input && (t.inputValidator = Ln.url));
    })(t),
        ...
        Kt.swalPromiseResolve.set(t, o),
          ...
          ((t, e) => {
            "select" === e.input || "radio" === e.input
              ? he(t, e)
              : ["text", "email", "number", "tel", "textarea"].some((t) => t === e.input) &&
